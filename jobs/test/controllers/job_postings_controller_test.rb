...
class JobPostingsControllerTest < ActionController::TestCase
  ...
  test "should create job_posting" do
    assert_difference('JobPosting.count') do
      post :create, job_posting: { date_applied: @job_posting.date_applied, location: @job_posting.location, notes: @job_posting.notes, title: @job_posting.title, url: @job_posting.url }
    end
  ...
  test "should update job_posting" do
    patch :update, id: @job_posting, job_posting: { date_applied: @job_posting.date_applied, location: @job_posting.location, notes: @job_posting.notes, title: @job_posting.title, url: @job_posting.url }
    assert_redirected_to job_posting_path(assigns(:job_posting))
  end
